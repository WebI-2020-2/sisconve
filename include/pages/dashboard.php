<div class="dashboard">
    ...
    <div class="main-page">
        <div class="dash-btns">
            <a href="clientes.php" style="background-color: #31736F;" class="button">
                <span><img src="../public/img/clientes-btn.svg" alt="">Clientes</span>
            </a>
            <a href="produtos.php" style="background-color: #A50000;" class="button">
                <span><img src="../public/img/produtos-btn.svg" alt="">Produtos</span>
            </a>
            <a href="#" style="background-color: #A1A500;" class="button">
