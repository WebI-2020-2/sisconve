            ...
            <div class="form">
                <form action="<?= URL ?>/FuncionarioController/cadastrar" method="POST">
                    <div class="input input-nome-funcionario">
                        ...
                        <input type="text" oninput="validaInput(this)" name="nome_funcionario" placeholder="José da Silva" required>
                    </div>
                    <div class="input-cpf-tel">
                        <div class="input input-cpf">
                            <label for="cpf">CPF <small>(somente números)</small></label>
                            <input type="text" oninput="validaInput(this)" name="cpf" placeholder="123.456.789-10" required>
                        </div>
                        <div class="input input-num-telefone">
                            <label for="telefone">Telefone + DDD <small>(somente números)</small></label>
                            <input type="text" oninput="validaInput(this)" name="telefone" placeholder="(38) 9 12345678" required>
                        </div>
                    </div>
                    <div class="input input-email">
                        <label for="email">E-mail</label>
                        <input type="text" oninput="validaInput(this)" name="email" placeholder="funcionario@email.com" required>
                    </div>
                    <div class="input input-endereco">
                        <label for="endereco">Endereço <small>(completo)</small></label>
                        <input type="text" oninput="validaInput(this)" name="endereco" placeholder="Rua dos Cocais, num 25 Bairro Centro, Espinosa-MG" required>
                    </div>
                    ...
                    <div class="input-usuario-nivel">
                        <div class="input input-usuario">
                            ...
                            <input type="text" oninput="validaInput(this)" style="background-color: #e5e5e5;" name="usuario" id="usuario" placeholder="usuario" required disabled>
                        </div>
                    ...
                    <div class="input-senha-confirm">
                        <div class="input input-senha">
                            ...
                            <input type="password" oninput="validaInput(this)" style="background-color: #e5e5e5;" name="senha" id="senha" placeholder="•••••••••••" required disabled>
                        </div>
